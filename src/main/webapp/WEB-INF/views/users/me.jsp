...
<form class="form-box" id="me-form" action="/users/action/signup" method="POST">
    <h1 class="form-title">My Page</h1>
    ...
    <div class="input-group" id="input-username">
        ...
        <input class="input-box" type="text" id="username" name="username" value="${authUser.username}" disabled>
    </div>
    <div class="input-group" id="input-password">
        <label id="label-password" for="password">PW : </label>
        <input class="input-box" type="password" id="password" name="password" value="00000000">
    </div>
    ...
    <div class="input-group" id="input-hospital-department">
        <div class="hospital-department">
            <div class="hospital" id="input-hospital">
                ...
                <input class="input-box" type="text" id="hospital" name="hospital" value="${authUser.hospitalName}">
            </div>
            <div class="department" id="input-department">
                <label id="label-department"  for="department">DP : </label>
                <input class="input-box" type="text" id="department" name="department" value="${authUser.department}">
            </div>
        </div>
    </div>
    ...
    <div class="input-group" id="input-name">
        ...
        <input class="input-box" type="text" id="name" name="name" value="${authUser.name}">
    </div>
    ...
    <div class="input-group" id="input-email">
        ...
        <div class="email-container">
            <input class="input-box" type="text" id="email" name="email" value="${authUser.email}" disabled>
        </div>
    </div>
    <div class="input-group" id="input-phone">
        <label id="label-phone" for="phone">PHONE : </label>
        <input class="input-box" type="text" id="phone" name="phone" value="${authUser.phone}">
    </div>
    <p class="error-msg" id="error-phone">전화번호 형식에 맞게 입력해주세요.</p>
    <p class="error-msg" id="error-phone2">전화번호가 중복됩니다.</p>
    <div class="button-container">
        <button type="submit" class="btn2 edit-btn">Edit</button>
        <button type="button" id="withdraw-btn" class="btn2 withdraw-btn">Withdraw</button>
    </div>
</form>
...
<div class="modal" id="myModal">
    <div class="modal-content">
        ...
        <div class="input-group">
            ...
            <input class="input-box" type="password" id="rewrite-password" name="rewrite-password">
        </div>
